package com.avinashpatil.notify;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        developerLayout.setOnClickListener(view -> {
        ...
        clearImageBtn.setOnClickListener(v -> clearImagePreview());
    ...
    private void showIncompleteDataAlert() {
        ...
        builder.setTitle("Incomplete Notification Data")
                ...
                .setPositiveButton("Yes", (dialog, which) -> showNotification())
    ...
    private void showNotification() {
        ...
        Intent openWebsiteIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Avi6855?tab=repositories"));
